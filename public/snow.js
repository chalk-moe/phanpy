...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (!embedimSnow) {
    ...
    embedimSnow.innerHTML = '<style>#embedim--snow{position:fixed;left:0;top:0;bottom:0;width:100vw;height:100vh;overflow:hidden;z-index:99;pointer-events:none}' + embCSS + '</style>' + embHTML;
